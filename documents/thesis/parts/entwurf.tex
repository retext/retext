...
Über das Suchfeld \ball{2} lässt sich die aktuellen Ansicht filtern. In der Kontextinformation findet sich direkter Zugang zu Informationen und Operationen bezogen auf den aktuellen Inhalt. Die Inhalte lassen sich über Formulare \ball{3} direkt bearbeiten, Notizen und Dateien werden angezeigt \ball{4} und die Diskussion mithilfe der Kommentarfunktion ist möglich \ball{5}.
...
\captionof{screenshot}[Browserbasiertes GUI des Prototyps]{Browserbasiertes GUI des Prototyps (vgl. Abschnitt \ref{l:gui-definition} / \pageref{l:gui-definition})}\label{chart:gui-prototyp}
\end{center}
