...
Jan arbeitet auf Seite der Agentur und stimmt sich mit \emph{Eva}~(\ref{p:eva}) über den Aufbau des Produktes ab und bekommt von \emph{Lotte}~(\ref{p:lotte}) Vorgaben zur Gestaltung. Von \emph{Markus}~(\ref{p:markus}) bekommt er letzte Änderungen um Text mitgeteilt, die erst bei der Darstellung im fertigen Produkt auffallen.
