...
Während der Umsetzung des Produkts ergeben sich Änderungen am Styleguide. Sie möchte, dass \emph{Jan} · \ref{p:jan} alle Stellen im Produkt anpasst, die von diesen Änderungen betroffen sind.
...
Jan entdeckt ein Problem mit der Textlänge einer Überschrift. Er meldet dieses Problem in der Anwendung. \emph{Lottes} · \ref{p:lotte} Änderungen betreffen alle Überschriften. Jan kann sich in der Anwendung alle betroffenen Stellen im Produkt anzeigen lassen.
