...
Die Orientierung an den REST-Prinzipien hat auch Einfluss auf die Konzeptionierung des Anwendungsservers (vgl. \cite[S.127]{rest}). Grundsätzlich ermöglicht dies den Verzicht auf komplexe Servlet Container mit langer Lebenszeit, die Ressourcen und Zustände zwischen Anfragen beibehalten. Der Anwendungsserver kann, vereinfacht gesprochen, als Input"=Output"=Maschine implementiert werden, dessen Lebenszyklus nur den Verlauf einer Anfrage überdauert. Dieses Programmiermodell findet sich in populären Sprachen zur Entwicklung von Webanwendungen, wie z.B. PHP oder Python, wird aber inzwischen auch wieder vermehrt von neueren Entwicklungen im Bereich der asynchronen Serversoftware, z.B. \trademark{NodeJS}\footnote{\url{http://nodejs.org/}} oder \trademark{vert.x}\footnote{\url{http://vertx.io/}}, aufgegriffen.
