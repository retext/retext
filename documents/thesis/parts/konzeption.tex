...
\textbf{Agentur} & & & \\
\hline\\[-1.5ex]
\emph{Eva}, Konzept & \HarveyHalf & \HarveyEmpty & \HarveyFull & \HarveyEmpty \\
...
\end{tabular}
\caption{Stärke des Einfluss, die Mitarbeiter in einem Projekt haben. (\HarveyEmpty = Kein Einfluss, \HarveyFull = Viel Einfluss)}
